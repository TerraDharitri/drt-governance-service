...
exports.RedisPubSubModule = exports.PUB_SUB = void 0;
...
var RedisPubSubModule = function () {
            ...
            providers: [
                {
                    ...
                    useFactory: function (configService) {
                        ...
                        return new graphql_redis_subscriptions_1.RedisPubSub({
                            publisher: (0, redisClient_1.setClient)(options),
                            subscriber: (0, redisClient_1.setClient)(options),
                        });
                    },
    ...
    var _classThis;
    var RedisPubSubModule = _classThis = /** @class */ (function () {
        function RedisPubSubModule_1() {
        }
        return RedisPubSubModule_1;
    }());
    __setFunctionName(_classThis, "RedisPubSubModule");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        RedisPubSubModule = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return RedisPubSubModule = _classThis;
}();
