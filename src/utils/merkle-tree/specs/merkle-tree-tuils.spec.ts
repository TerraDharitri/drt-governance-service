...
describe('Merkle Tree', () => {
    it('Valid Leaves', () => {
        const leaves = [
            {
                address:
                    'drt1sdslvlxvfnnflzj42l8czrcngq3xjjzkjp3rgul4ttk6hntr4qds3x86gw',
                balance: '1',
                votingPower: '1',
            },
            {
                address:
                    'drt1h2rx7vq29m26ut0rh5x4qnmjk2d93ycukp33jl3at04lhaejzhgqmg50aq',
                balance: '2',
                votingPower: '2',
            },
        ];
    ...
    it('Invalid leaves, wrong addresses', () => {
        ...
        const badLeaves = [
            {
                address:
                    'drt1ha5u92fx54y60lh7wsy7uev8sz2f96gza2n8r0v2ha92jn7ap3ps8rs77l',
                balance: '1',
                votingPower: '1',
            },
            {
                address:
                    'drt1w547kw69kpd60vlpr9pe0pn9nnqeljrcaz73znenjpgt0h3qlqqqxd8p9v',
                balance: '2',
                votingPower: '2',
            },
        ];
