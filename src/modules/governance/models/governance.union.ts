...
import {
    ...
    DescriptionV1,
    DescriptionV2,
} from './governance.proposal.model';

export const GovernanceUnion = createUnionType({
    name: 'GovernanceTypes',
    types: () =>
        [GovernanceTokenSnapshotContract, GovernanceEnergyContract] as const,
...
export const GovernanceDescriptionUnion = createUnionType({
    ...
    types: () => [DescriptionV0, DescriptionV1, DescriptionV2] as const,
