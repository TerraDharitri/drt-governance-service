...
exports.FlagSchema = exports.Flag = void 0;
...
var Flag = function () {
    ...
    var Flag = _classThis = /** @class */ (function () {
        function Flag_1() {
            this.name = __runInitializers(this, _name_initializers, void 0);
            this.value = (__runInitializers(this, _name_extraInitializers), __runInitializers(this, _value_initializers, void 0));
            __runInitializers(this, _value_extraInitializers);
        }
        return Flag_1;
    }());
    __setFunctionName(_classThis, "Flag");
    (function () {
        ...
        Flag = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return Flag = _classThis;
}();
exports.Flag = Flag;
exports.FlagSchema = mongoose_1.SchemaFactory.createForClass(Flag).index({
    name: 1,
}, { unique: true });
