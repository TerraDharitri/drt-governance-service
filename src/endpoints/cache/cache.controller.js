...
var CacheController = function () {
    ...
    var CacheController = _classThis = /** @class */ (function () {
        function CacheController_1(logger, cachingService) {
            this.logger = (__runInitializers(this, _instanceExtraInitializers), logger);
            this.cachingService = cachingService;
        }
        CacheController_1.prototype.deleteCacheKey = function (keys) {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            key = keys_1[_i];
                            return [4 /*yield*/, this.cachingService.deleteLocal(key)];
                        case 2:
                            _a.sent();
                            _a.label = 3;
                        case 3:
    ...
    (function () {
        ...
        _deleteCacheKey_decorators = [(0, microservices_1.EventPattern)('deleteCacheKeys')];
